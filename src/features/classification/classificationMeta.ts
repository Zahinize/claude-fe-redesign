...
export const LEVEL_META: Record<ClassificationLevel, LevelMeta> = {
  'Top Secret': { tone: 'danger', circle: 'bg-danger-500', bar: 'bg-danger-500', border: 'border-danger-100', text: 'text-danger-600', soft: 'bg-danger-50' },
  Secret: { tone: 'warning', circle: 'bg-warning-500', bar: 'bg-warning-500', border: 'border-warning-100', text: 'text-warning-600', soft: 'bg-warning-50' },
  Restricted: { tone: 'brand', circle: 'bg-brand-600', bar: 'bg-brand-600', border: 'border-brand-100', text: 'text-brand-600', soft: 'bg-brand-50' },
  Public: { tone: 'success', circle: 'bg-success-500', bar: 'bg-success-500', border: 'border-success-100', text: 'text-success-600', soft: 'bg-success-50' },
  Unclassified: { tone: 'neutral', circle: 'bg-neutral-400', bar: 'bg-neutral-300', border: 'border-neutral-200', text: 'text-fg-muted', soft: 'bg-neutral-100' },
}
